...
export function SentimentBadge({
  ...
  return (
    <Badge
      variant="outline"
      className={`relative cursor-pointer overflow-visible transition-colors select-none ${
        isSelected
          ? isPositive
    ...
    >
      ...
      {isSelected && (
        <span
          className={`absolute -top-2 -right-2 z-10 flex h-4 w-4 items-center justify-center rounded-full border bg-white text-xs font-bold shadow-sm ${
            isPositive
