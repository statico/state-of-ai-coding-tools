...
import { loadConfig, validateConfigReferences, validateUniqueSlugs } from "@/lib/config.js";
...
try {
  ...
  console.log("🎉 Config validation passed! All checks completed successfully.");
} catch (error) {
